// ============================================================
// license/mod.rs — Cryptographic HWID License Verification & Keygen
...
impl LicenseManager {
    ...
    /// File path where license is stored (%APPDATA%/jrt_tech_license.lic or ~/.jrt_tech_license.lic)
...
// Minimal dirs_next helper for cross-platform config dir
mod dirs_next {
    use std::path::PathBuf;
